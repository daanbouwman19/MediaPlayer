...
**Action:** Replace object rest destructuring and `Object.values()` with explicit undefined checks for known properties in high-frequency paths to eliminate allocation overhead.
