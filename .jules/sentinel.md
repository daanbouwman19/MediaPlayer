...
**Prevention:** Implemented a hard limit (`MAX_QUEUE_SIZE = 50`) on the `MediaAnalyzer` job queue. Requests exceeding this limit are immediately rejected with a "Server busy" error.
